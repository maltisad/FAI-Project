...
<div id="main">
        ...
        <div class="info-wrapper">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Mirembajtje</li>
            </ol>
          </nav>
          <div class="info-panel d-flex">
            <h4 class="title">Regjistrimi i Kerkesave</h4>
          </div>
        </div>
        <div class="block-1">
          <div class="control d-flex">
           
            <button type="button" class="btn custom-modal" data-toggle="modal" data-target="#exampleModalCenter"> Shto Kerkese te Re
                  ...
                  <div class="modal-body d-flex">
                   ...
                   <div class="form-group ">
                           <div class="content d-flex">
                            <div class="input-group c-item " style="margin-bottom:20px;">
                           ...
                           <div class="content d-flex">
                            <div class="input-group c-item ">
                              <div class="input-group-prepend">
                                ...
                                <asp:DropDownList ID="PunetoriDropDownList" DataTextField="Punetori" 
                                DataValueField="PunetoriID" runat="server" CssClass="input-group-text">
                                </asp:DropDownList> 
                            </div>
                           </div>
                          </div>
                            ...
                            <asp:TextBox ID="PershkrimiTextBox" runat="server" placeholder="Shkruani pershkrimin " CssClass="form-control form-title"></asp:TextBox>
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                Lista e Kerkesave te Regjistruara
            </div>
        ...
        <div class="portlet-body flip-scroll">
            <asp:GridView
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Punetori" InsertVisible="False">
                        <ItemTemplate>

                            <asp:Label ID="PunetoriLabel" runat="server" Text='<%# Bind("PunetoriID") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                      ...
                      <asp:TemplateField HeaderText="Data" InsertVisible="False">
                        <ItemTemplate>
                            <asp:Label ID="DataLabel" runat="server" Text='<%# Bind("DataMirmbajtjes") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <ItemTemplate>
                             <asp:LinkButton ID="EditButton"
                                ...
                                CommandArgument='<%# Bind("MirembajtjaID") %>'
