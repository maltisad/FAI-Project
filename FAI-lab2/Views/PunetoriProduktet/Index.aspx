<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="FAI_lab2.Views.PunetoriProduktet.Index" %>
        ...
        <div class="info-wrapper">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">CaktoProduktin</li>
            </ol>
          </nav>
          <div class="info-panel d-flex">
            <h4 class="title">Caktimi i produkteve</h4>
          </div>
        </div>
        <div class="block-1">
                      ...
                      <div class="product-info">
                       ...
                       <div class="form-group ">
                           ...
                           <div class="content d-flex">
                            <div class="input-group c-item ">
                              <div class="input-group-prepend">
                                   <asp:Label ID="Label1" runat="server"  for="inputGroupSelect01" Text="Produkti" CssClass="input-group-text"></asp:Label>
                               </div>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Punetori" InsertVisible="False">
                      ...
                      <asp:TemplateField HeaderText="Data" InsertVisible="False">
                        <ItemTemplate>
                            <asp:Label ID="DataLabel" runat="server" Text='<%# Bind("DataPP") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
