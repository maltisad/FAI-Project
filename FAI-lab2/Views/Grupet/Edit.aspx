<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="FAI_lab2.Views.Grupet.Edit" %>
...
<link rel='stylesheet' href='https://fonts.googleapis.com/css?family=Montserrat:400,500,600,700,800,900'>
   ...
   <asp:HyperLink ID="ShtoHyperLink" runat="server" Text="Features" NavigateUrl="~/Views/Features/About.aspx" CssClass="btn-link"></asp:HyperLink>
    ...
    <div class="form-horizontal">
        <div class="row">
            <asp:Label ID="TitlePageLabel" Text="Ndrysho Grupin" runat="server" class="col-md-3 control-label" Style="color: #337ab7; font-weight: bold;"></asp:Label>
        </div>
        <div class="form-body">
