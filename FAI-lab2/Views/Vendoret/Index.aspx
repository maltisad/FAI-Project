<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="FAI_lab2.Views.Vendoret.Index" %>
    ...
    <div class="container">
        ...
        <div class="info-wrapper">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">Vendoret</li>
            </ol>
          </nav>
          <div class="info-panel d-flex">
            <h4 class="title">Regjistrimi i Vendoreve</h4>
          </div>
        </div>
        <div class="block-1">
              ...
              <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Regjistrimi i  Vendorit</h5>
                    ...
                    <div class="right-panel">
                      <div class="product-info">
                        <div class="form-group">
                          ...
                          <label class="item-name">Informacionet e Vendorit</label><br />
                       ...
                       <div class="form-group">
                             ...
                             <asp:Label ID="LokacioniLabel"  runat="server" ></asp:Label>
                  ...
                  <div class="form-group">
                             ...
                             <asp:Label ID="NrKontaktuesLabel"  runat="server" ></asp:Label>
                            <asp:TextBox ID="NrKontaktuesTextBox" runat="server" placeholder="Numri Kontaktues" CssClass="form-control form-title"></asp:TextBox>
                        
                        </div>
                          <div class="form-group">
                         
                             <asp:Label ID="Label1"  runat="server" ></asp:Label>
                            <asp:TextBox ID="BankAccountTextBox" runat="server" placeholder="Numri i Llogarie Bankare " CssClass="form-control form-title"></asp:TextBox>
     ...
     <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
             Lista e Vendoreve te Regjistruar
            </div>
